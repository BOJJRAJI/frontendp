...
class Home extends Component {
  ...
  sendMessage = (e) => {
    e.preventDefault();
    const { message, name, email, phone } = this.state;
    ...
    if (name === "") {
      ...
      this.setState({
        showFormError: true,
        contactError: "Enter Your phone Number Correctly!",
      });
    } else if (message === "") {
      ...
      <div>
          ...
          <div class="container">
            ...
            <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div className="navbar-nav ml-auto">
                ...
                <a className="nav-link" href="#sectionLocation" id="navItem2">
                  Location
                </a>
                <a className="nav-link" href="#sectionContactUs" id="navItem3">
                  Contact Us
                </a>
                <Link to="/orderPage">
        ...
        <div className="about-us-bg-container" id="sectionAboutUs">
          <div className="about-us-container">
            ...
            <p className="about-us-para">
              Pizza Boyz located in Glen Eden, serve the best tasting Pizzas out
              West Auckland. We use only the best quality ingredients to make
              our fresh, tasty pizza, with an extensive menu that will have
              something to suit everyone's taste and budget. Pizza Boyz invite
              you to order online for your convenience with option of takeaway
              pickup or delivery to your door. Pizza Boyz look forward to
              serving you your delicious pizzas soon to satisfy those pizza
              cravings!!
            </p>
        ...
        <div className="app-install-container">
          <div className="install-container">
            <div className="app-install-heading-container">
              <p className="install-app-heading">
                Install our app and make your ordering experience better
              </p>
            </div>
        ...
        <div className="images-bg-container">
          <div className="images-container">
            <img
              src="https://bno-restaurant-images.imgix.net/1b193fa4-130c-4484-b42d-0b79b45607f4.jpg?fm=jpg&h=275&fit=clip&lossless=1"
              alt="pizza1"
              className="item-image"
            />
            <img
              src="https://bno-restaurant-images.imgix.net/1a57eca6-c377-48a2-85fb-fc153a67cbde.jpg?fm=jpg&h=275&fit=clip&lossless=1"
              alt="pizza2"
              className="item-image"
            />
            <img
              src="https://bno-restaurant-images.imgix.net/978eaeb7-02f1-46f4-b1f9-112ac947de1e.jpeg?fm=jpg&h=275&fit=clip&lossless=1"
              alt="pizza3"
              className="item-image"
            />
            <img
              src="https://bno-restaurant-images.imgix.net/6814990b-ef08-49ba-802f-6ee1c0a0e782.jpeg?fm=jpg&h=275&fit=clip&lossless=1"
              alt="pizza4"
              className="item-image"
            />
            <img
              src="https://bno-restaurant-images.imgix.net/2c59617e-bccc-435b-8b6f-3770650b0003.jpg?fm=jpg&h=275&fit=clip&lossless=1"
              alt="pizza15"
              className="item-image"
            />
            <img
              src="https://bno-restaurant-images.imgix.net/94b0f915-1800-424d-8380-faf17e9a34ab.jpg?fm=jpg&h=275&fit=clip&lossless=1"
              alt="pizza16"
              className="item-image"
            />
          </div>
          ...
          <div className="location-container">
            ...
            <div>
              <iframe
                ...
                marginHeight="0"
                marginWidth="0"
                src="https://maps.google.com/maps?width=600&amp;height=300&amp;hl=en&amp;q=5/182%20West%20Coast%20Road,%20Glen%20Eden,%20Auckland%200602,%20New%20Zealand+(Glen%20Eden)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
              >
        ...
        <div className="footer-bg-container">
          <div className="footer-container">
            <div className="social-media-icons-container">
              <a
                href="https://www.facebook.com/pizzaboyz.gleneden/"
                target="__blank"
              >
